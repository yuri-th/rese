...
<div class="shop-information">
  ...
  <div class="form-contents">
    ...
    <div class="shop-create">
      ...
      <form class="csv_import" action="{{ route('shops.import') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div>
  ...
  <div class="shop-list">
    <div class="table-page">
      ...
      <p>全{{ $shop_infos->total() }}件中
        ...
        {{ ($shop_infos->currentPage() - 1) * $shop_infos->perPage() + 1 + (count($shop_infos) - 1) }}件
      </p>
    @else
    <p>データがありません。</p>
  @endif
