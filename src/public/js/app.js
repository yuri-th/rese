...
document.addEventListener('DOMContentLoaded', function () {
  var ratingApp = document.getElementById('ratingApp');
  if (ratingApp) {
  ...
  document.querySelectorAll('.user-post').forEach(function (el, index) {
    var starsEl = el.querySelector('.star-rating');
    if (starsEl) {
      new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
        el: starsEl,
        data: {
  ...
  document.querySelectorAll('.other-user-post .star-rating').forEach(function (el, index) {
    new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
      el: el,
      data: {
